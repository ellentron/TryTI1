...
class UiRunControl(ctk.CTkFrame):
    def __init__(self, master=None, **kwargs):
        ...
        self.progress_label.grid(row=2, column=0, sticky="nsew", padx=(0, 10), pady=(10, 10))

        # Create progress bar
        self.progress_bar = ctk.CTkProgressBar(self.run_control_frame)
        self.progress_bar.grid(row=2, column=1, columnspan=3, sticky="nsew", padx=(0, 0), pady=(15, 15))

        # Create label "50%"
        self.progress_label = ctk.CTkLabel(self.run_control_frame, text="50%")
        self.progress_label.grid(row=2, column=4, sticky="nsw", padx=(0, 5), pady=(0, 0))
...
class UiPowerMeter(ctk.CTkFrame):
    def __init__(self, master=None, **kwargs):
        ...
        self.ui_pm_connect_frame.grid(row=1, column=0, sticky="nw", padx=(10, 10), pady=(10, 10))
